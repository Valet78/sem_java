 ...
 *          2. А=2 + 1(нажали К2) * 2(нажали К1) + 1(нажали К2) + 1(нажали К2) + 1(нажали К2) -> В=9
 *          3. А=2 * 2(нажали К1) + 1(нажали К2) + 1(нажали К2) + 1(нажали К2) + 1(нажали К2) + 1(нажали К2) -> В=9
 *          4. А=2 * 2 (нажали К1)* 2(нажали К1) + 1(нажали К2) -> В=9
 */
